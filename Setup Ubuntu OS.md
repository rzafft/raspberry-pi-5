...
1. Write the OS onto the nvme ssd using the Raspberry Pi Imager.

	* Operating System: Ubuntu Desktop 24.04.3 LTS (64-bit) OS to the NVMe SSD 
	* Storage: ACASIS EC 6606 Media NVME SSD
...
3. Configuration
  ...
  * Username: Linus
  * Password: BreakpointFranceDeltaPack00!
